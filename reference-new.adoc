...
== 9.13.1 P14 (16 April 2025)
The 9.13.1 P14 patch is now available for Cloud Volumes ONTAP for all cloud providers. BlueXP will prompt you to upgrade your existing systems to this patch release.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.13.1P14[View the list of bugs fixed in the P14 patch^] (NetApp Support Site login required).

== 9.13.1 P13 (20 January 2025)
The 9.13.1 P13 patch is now available for Cloud Volumes ONTAP for all cloud providers. BlueXP will prompt you to upgrade your existing systems to this patch release.

link:https://mysupport.netapp.com/site/products/all/details/cloud-volumes-ontap/downloads-tab/download/62632/9.13.1P13[View the list of bugs fixed in the P13 patch^] (NetApp Support Site login required).
