...
The 9.13.1 P4 patch is now available for Cloud Volumes ONTAP for AWS if you have a Connector running version 3.9.26 or later. BlueXP will prompt you to upgrade your existing systems to this patch release.
